use crate::systems::user_interface::{
    interactions::{
        ...
        select_animal_button::select_animal_button,
        select_animal_menu_button::select_animal_menu_button,
        select_fence_button::select_fence_button,
        select_fence_menu_button::select_fence_menu_button,
        select_path_button::select_path_button,
        select_path_menu_button::select_path_menu_button,
        ...
        select_tree_button::select_tree_button,
        select_tree_menu_button::select_tree_menu_button,
