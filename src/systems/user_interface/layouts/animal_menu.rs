...
pub fn animal_menu(contexts: &mut EguiContexts, selected_menu_item: &mut ResMut<SelectedMenuItem>) {
    egui::Window::new("Animals").show(
        contexts.ctx_mut().expect("Animals Menu failed to render"),
        |ui| {
            ...
            if ui.add(egui::Button::new("Chicken")).clicked() {
                selected_menu_item.reset();
                selected_menu_item.animal_selection =
                    AnimalSprite::convert_from(AnimalIcon::Chicken);
            }
            ...
            if ui.add(egui::Button::new("Gorilla")).clicked() {
                selected_menu_item.reset();
                selected_menu_item.animal_selection =
                    AnimalSprite::convert_from(AnimalIcon::Gorilla);
            }
            if ui.add(egui::Button::new("Monkey")).clicked() {
                selected_menu_item.reset();
                selected_menu_item.animal_selection =
                    AnimalSprite::convert_from(AnimalIcon::Monkey);
            }
            ...
            if ui.add(egui::Button::new("Porcupine")).clicked() {
                selected_menu_item.reset();
                selected_menu_item.animal_selection =
                    AnimalSprite::convert_from(AnimalIcon::Porcupine);
            }
            ...
            if ui.add(egui::Button::new("Turtle")).clicked() {
                selected_menu_item.reset();
                selected_menu_item.animal_selection =
                    AnimalSprite::convert_from(AnimalIcon::Turtle);
            }
