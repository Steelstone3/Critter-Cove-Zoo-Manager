...
pub fn select_fence_menu_button(
    ...
    match *select_fence_menu_button_query.interaction {
        Interaction::Pressed => {
            ...
            *select_fence_menu_button_query.border_color = Color::srgb(255.0, 238.0, 88.0).into();
        ...
        Interaction::None => {
            *select_fence_menu_button_query.border_color = Color::srgb(189.0, 189.0, 189.0).into();
        }
    }
}
